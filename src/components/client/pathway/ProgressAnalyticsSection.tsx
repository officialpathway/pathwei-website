    ...
    <ContentSection
      ...
      visual={
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
          <div className="p-3 bg-emerald-50 rounded-lg mb-4">
            <h4 className="font-medium text-emerald-800 mb-3">{t("weekly_progress")}</h4>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {metrics.map((metric, index) => (
              <div key={index} className="py-2 px-4 bg-emerald-100 text-emerald-800 rounded-full text-sm">
                {metric}
              </div>
            ))}
          </div>
      ...
      additionalContent={
        <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-lg mt-6">
          <h4 className="font-medium text-emerald-800 mb-2">{t("key_insight.title")}</h4>
