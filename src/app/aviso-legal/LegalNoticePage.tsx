    ...
    <div className="bg-white text-gray-800 pt-24">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.general_info.title")}</h2>
          <p className="mb-4">{t("sections.general_info.intro")}</p>
          
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <p className="mb-2"><strong>{t("sections.general_info.website_owner_label")}</strong> {t("sections.general_info.website_owner")}</p>
            <p className="mb-2"><strong>{t("sections.general_info.email_label")}</strong> {t("sections.general_info.email")}</p>
            <p className="mb-2"><strong>{t("sections.general_info.website_label")}</strong> {t("sections.general_info.website")}</p>
          </div>
          
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
            <p className="font-semibold text-blue-800">{t("sections.general_info.note")}</p>
          </div>
        </section>

        {/* II. General Terms and Conditions */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.general_terms.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.general_terms.object.title")}</h3>
            <p className="mb-4">{t("sections.general_terms.object.description")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              {websiteElements.map((element, index) => (
                <li key={index}>{element}</li>
              ))}
            </ul>
            <p className="mb-4">{t("sections.general_terms.object.modification_rights")}</p>
          </div>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.general_terms.access.title")}</h3>
            <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        {/* III. The User */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.user.title")}</h2>
          <p className="mb-6">{t("sections.user.intro")}</p>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.user.responsibilities.title")}</h3>
            <p className="mb-4">{t("sections.user.responsibilities.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              {userResponsibilities.map((responsibility, index) => (
                <li key={index}><strong>{responsibility.split(':')[0]}:</strong> {responsibility.split(':')[1]}</li>
              ))}
            </ul>
          </div>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.user.target_audience.title")}</h3>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.access_guarantees.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.access_guarantees.availability.title")}</h3>
            <p className="mb-4">{t("sections.access_guarantees.availability.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              {noGuarantees.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
            <p className="mb-4">{t("sections.access_guarantees.availability.efforts")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.access_guarantees.limitation.title")}</h3>
            <p className="mb-4">{t("sections.access_guarantees.limitation.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        {/* V. Links Policy */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.links.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.links.outgoing.title")}</h3>
            <p className="mb-4">{t("sections.links.outgoing.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              {outgoingLinks.map((link, index) => (
                <li key={index}><strong>{link.split(':')[0]}:</strong> {link.split(':')[1]}</li>
              ))}
            </ul>
          </div>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.links.external_responsibility.title")}</h3>
            <p className="mb-4">{t("sections.links.external_responsibility.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              {externalResponsibility.map((item, index) => (
                <li key={index}><strong>{t("sections.links.external_responsibility.pathway_prefix")}:</strong> {item}</li>
              ))}
            </ul>
          </div>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.links.incoming.title")}</h3>
            <p className="mb-4">{t("sections.links.incoming.intro")}</p>
            
            <div className="mb-4">
              <h4 className="font-semibold mb-2 text-green-700">{t("sections.links.incoming.allowed.title")}</h4>
              <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <div className="mb-4">
              <h4 className="font-semibold mb-2 text-red-700">{t("sections.links.incoming.prohibited.title")}</h4>
              <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.intellectual_property.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.intellectual_property.pathway_rights.title")}</h3>
            <p className="mb-4">{t("sections.intellectual_property.pathway_rights.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.intellectual_property.user_use.title")}</h3>
            
            <div className="mb-4">
              <h4 className="font-semibold mb-2 text-green-700">{t("sections.intellectual_property.allowed_use.title")}</h4>
              <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <div className="mb-4">
              <h4 className="font-semibold mb-2 text-red-700">{t("sections.intellectual_property.prohibited_use.title")}</h4>
              <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.intellectual_property.legal_protection.title")}</h3>
            <p className="mb-4">{t("sections.intellectual_property.legal_protection.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        {/* VII. Modifications */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.modifications.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.modifications.changes.title")}</h3>
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.modifications.notification.title")}</h3>
            <p className="mb-4">{t("sections.modifications.notification.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.legislation.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.legislation.applicable_regulations.title")}</h3>
            <p className="mb-4">{t("sections.legislation.applicable_regulations.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.legislation.jurisdiction.title")}</h3>
            <p className="mb-4">{t("sections.legislation.jurisdiction.intro")}</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.contact.general.title")}</h3>
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <p className="mb-2"><strong>{t("sections.contact.general.email_label")}</strong> {t("sections.contact.general.email")}</p>
              <p><strong>{t("sections.contact.general.subject_label")}</strong> {t("sections.contact.general.subject")}</p>
            </div>
          </div>

          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.contact.specialized.title")}</h3>
            {specializedContacts.map((contact, index) => (
              <div key={index} className="mb-3 p-3 border border-gray-200 rounded-lg">
                <p className="mb-1"><strong>{contact.type}:</strong> {contact.email}</p>
