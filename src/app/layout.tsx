...
export const metadata: Metadata = {
  ...
  description:
    "Maximiza tu productividad y motivación con Pathwei, la app gamificada que usa inteligencia artificial para ayudarte a alcanzar tus metas diarias. Descarga ahora.",
  keywords: [
  ...
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL || "https://www.mypathwayapp.com"
  ),
  ...
  openGraph: {
    ...
    description:
      "Convierte tus metas en juegos, conéctate con amigos y deja que la IA te ayude a lograr más cada día con Pathwei.",
