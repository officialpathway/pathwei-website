    ...
    <div className="bg-white text-gray-800 pt-24">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.what_are.title")}</h2>
          <p className="mb-4">{t("sections.what_are.paragraph1")}</p>
          <p className="mb-4">{t("sections.what_are.paragraph2")}</p>
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
            <p className="font-semibold text-blue-800">{t("sections.what_are.important_note")}</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          {/* Technical Cookies */}
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.technical.title")}</h3>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li><strong>{t("sections.technical.purpose_label")}</strong> {t("sections.technical.purpose")}</li>
              <li><strong>{t("sections.technical.duration_label")}</strong> {t("sections.technical.duration")}</li>
              <li>
                <strong>{t("sections.technical.data_label")}</strong>
                {technicalCookiesData.map((item, index) => (
                  <div key={index} className="ml-6 mt-2">{item}</div>
                ))}
              </li>
              <li><strong>{t("sections.technical.legal_basis_label")}</strong> {t("sections.technical.legal_basis")}</li>
            </ul>
          ...
          {/* Analytical Cookies */}
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.analytical.title")}</h3>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li><strong>{t("sections.analytical.purpose_label")}</strong> {t("sections.analytical.purpose")}</li>
              <li><strong>{t("sections.analytical.duration_label")}</strong> {t("sections.analytical.duration")}</li>
              <li>
              ...
              <li><strong>{t("sections.analytical.legal_basis_label")}</strong> {t("sections.analytical.legal_basis")}</li>
            </ul>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.not_used.title")}</h2>
        ...
        {/* Consent Management */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.consent.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.consent.subtitle")}</h3>
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.withdrawal.title")}</h3>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.browser_config.title")}</h2>
          ...
          {browserInstructions.map((browser, index) => (
            <div key={index} className="mb-4 p-4 border border-gray-200 rounded-lg">
              ...
              {browser.url && <p className="text-sm text-blue-600">{t("sections.browser_config.or_visit")} {browser.url}</p>}
            </div>
          ))}
        </section>
        ...
        {/* Do Not Track Tools */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.dnt_tools.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.consequences.title")}</h2>
          
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.consequences.accepting.title")}</h3>
            <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">{t("sections.consequences.rejecting.title")}</h3>
            <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
            <p className="font-semibold text-blue-800">{t("sections.consequences.important_note")}</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.duration.title")}</h2>
          <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        {/* Policy Updates */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.updates.title")}</h2>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="mb-2"><strong>{t("sections.contact.email_label")}</strong> {t("sections.contact.email")}</p>
            <p className="mb-4"><strong>{t("sections.contact.subject_label")}</strong> {t("sections.contact.subject")}</p>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.regulations.title")}</h2>
