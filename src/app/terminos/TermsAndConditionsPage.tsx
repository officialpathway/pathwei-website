    ...
    <div className="bg-white text-gray-800 pt-24">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="mb-10">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.usage.personal_use.title")}</h3>
          <p className="mb-4">{t("sections.usage.personal_use.description")}</p>
          <p className="mb-4">{t("sections.usage.personal_use.confirmation")}</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.process.title")}</h2>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.process.registration.title")}</h3>
          <p className="mb-4">{t("sections.process.registration.description")}</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.process.service_modes.title")}</h3>
          <h4 className="text-lg font-medium mb-2">{t("sections.process.service_modes.free.title")}</h4>
          ...
          <h4 className="text-lg font-medium mb-2">{t("sections.process.service_modes.premium.title")}</h4>
          <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        {/* License Terms */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.license.title")}</h2>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.license.grant.title")}</h3>
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.license.restrictions_title")}</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.license.intellectual_property.title")}</h3>
          <p className="mb-4">{t("sections.license.intellectual_property.description")}</p>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.license.app_store.title")}</h3>
          <p className="mb-4">{t("sections.license.app_store.description")}</p>
        </section>

        {/* Subscription Policy */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.subscriptions.title")}</h2>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.subscriptions.monthly.title")}</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.subscriptions.cancellation_process.title")}</h3>
          <p className="mb-4">{t("sections.subscriptions.cancellation_process.description")}</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.subscriptions.cancellation_terms_title")}</h3>
          <p className="mb-4">{t("sections.subscriptions.cancellation_terms_intro")}</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.subscriptions.refunds.title")}</h3>
          <p className="mb-4">{t("sections.subscriptions.refunds.description")}</p>
        </section>

        {/* Feedback */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.feedback.title")}</h2>
        ...
        {/* Service Termination */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.termination.title")}</h2>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.termination.by_pathway.title")}</h3>
          <p className="mb-4">{t("sections.termination.by_pathway.description")}</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-3">{t("sections.termination.by_user.title")}</h3>
          <p className="mb-4">{t("sections.termination.by_user.description")}</p>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.termination.effects_title")}</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        {/* Jurisdiction */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.jurisdiction.title")}</h2>
        ...
        {/* General Provisions */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("sections.general.title")}</h2>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.general.severability.title")}</h3>
          <p className="mb-4">{t("sections.general.severability.description")}</p>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.general.complete_agreement.title")}</h3>
          <p className="mb-4">{t("sections.general.complete_agreement.description")}</p>
          
          <h3 className="text-xl font-semibold mb-3">{t("sections.general.waiver.title")}</h3>
        ...
        <section className="mb-10">
          ...
          <ul className="list-none mb-4 space-y-2">
            <li><strong>Email:</strong> {t("sections.contact.email")}</li>
            <li><strong>Asunto:</strong> {t("sections.contact.subject")}</li>
            <li><strong>Dirección postal:</strong> {t("sections.contact.address")}</li>
          </ul>
