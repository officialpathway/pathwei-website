...
export default function UsersManagement() {
  ...
  if (loading) {
    return (
      <div className="flex h-screen items-center justify-center bg-gray-950 text-gray-200">
  ...
  if (error) {
    return (
      <div className="flex h-screen items-center justify-center bg-gray-950 text-gray-200">
        <div className="text-center">
          <div className="bg-red-500/20 text-red-500 p-4 rounded-lg mb-4">{error}</div>
  ...
  return (
    <div className="h-[100vh] p-6 space-y-6 bg-gray-950 text-gray-200">
